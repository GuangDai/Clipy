...
| 2026-08-23 | X.9 F0A evidence-only UDS discriminator started. The branch contains an app-side [`UnixSocketF0Listener`](../../ClipyApp/Sources/Automation/UnixSocketF0Listener.swift), probe-only [`UnixSocketF0Protocol`](../../ClipyApp/Tools/ClipyUDSF0Shared/UnixSocketF0Protocol.swift), diagnostic [`ClipyUDSF0Client`](../../ClipyApp/Tools/ClipyUDSF0Client/ClipyUDSF0Client.swift), and a dispatch-only ad-hoc signed runtime workflow. It is compile-time isolated and has no X.8 JSON, History/Gateway, credential, enrollment, or authenticated-ingress path. The exact flagged artifact completed cold/warm, half-frame, normal-cleanup, and SIGKILL/stale-recovery cells. | X.9 / PLAY-PY-F0A | in progress | [signed-runtime run 32615713100](https://github.com/GuangDai/Clipy/actions/runs/32615713100) green; PR correctness pending |
