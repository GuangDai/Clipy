...
- **Status:** X.1/X.2 contracts, X.3 schema/bootstrap, X.4 audit/admin,
  **X.5 internal denial, and X.6 positive Gateway/public facade are landed.**
  ...
  migration/rollback/restart suite. **X.7 App Intents composition is the current
  unmerged implementation leaf** and remains gated on its own
  correctness/product/security evidence.
