...
- **Status:** done and accepted — the dedicated 47-test D1–D19 invariant suite
  (Acceptance, 02 §14) is green in supported macOS run 31449682036.
...
- **Acceptance remediation — complete:** the
  ...
  not replace them"). Supported macOS 26 / Swift 6.2 run 31449682036 is green.
