...
public enum DisplayMemoryPressure: Sendable, Equatable {
    case normal
    case warning
    case critical
}
...
extension EnvironmentValues {
    package var displayMemoryPressure: DisplayMemoryPressure {
    ...
    package var displayMemoryPressureGeneration: Int {
