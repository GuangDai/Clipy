...
// V2-09 §10: fixture construction uses the same public count policy and
// resource limits as the product. This helper only validates runner inputs.
extension SQLiteHistory {
    package static func openPerformanceFixture(
        ...
        return try await open(configuration: HistoryConfiguration(
