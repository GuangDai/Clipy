...
internal struct RetentionSettingsDraft {
    ...
    /// The persisted comparison baseline, never the pending field values.
    internal var configuredRetentionConfiguration: HistoryRetentionConfiguration {
        HistoryRetentionConfiguration(
            maximumUnpinnedItems: configuredMaximumUnpinnedItems, policies: configuredPolicies
        )
    }
