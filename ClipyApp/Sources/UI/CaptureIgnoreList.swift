...
struct CaptureIgnoreList: Equatable, Sendable {

    /// The UserDefaults key carrying the persisted `[String]` of
    /// normalized bundle identifiers.
    static let defaultsKey = "clipy.capture.ignoredBundleIDs"
    ...
    static func load(from defaults: UserDefaults) -> CaptureIgnoreList {
        CaptureIgnoreList(
