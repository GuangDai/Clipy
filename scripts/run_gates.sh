...
#
#   1. scripts/tests/test_diagnostic_scan.py — CI diagnostic parser negative fixtures
...
if ! PYTHONPATH="$REPO_ROOT" python3 -m unittest scripts.tests.test_diagnostic_scan; then
    status=1
fi
